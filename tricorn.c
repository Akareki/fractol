...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/30 13:28:24 by aoizel            #+#    #+#             */
/*   Updated: 2023/12/01 11:18:11 by aoizel           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fractol.h"

int	tricorn_iter(double x, double y, t_win_param *win_param)
{
	int		i;
	double	a;
	double	a2;
...
void	draw_tricorn(t_win_param *win_param)
{
	...
	while (j < win_param->size_y)
	{
		...
		{
			c = tricorn_iter(win_param->center_x
